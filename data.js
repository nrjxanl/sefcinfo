...
id = JSON.stringify(JSON.parse(localStorage.getItem("id")).slice(-1)[0])
dataList = data[id]
...
function redirect() {
    $("#recentMatch > div").each(function(index) {
        $(this).click(function() {
            idList = JSON.parse(localStorage.getItem("id"))
            idList.push(Number(h2hList[index]))
