...
function matchH2H() {
    ...
    hrefH = homeImg.replace("_s", "").replace(/[0-9]/g, "")
    hrefA = awayImg.replace("_s", "").replace(/[0-9]/g, "")
    ...
    // 최근 맞대결 결과
    if ($("#matchScore > div:nth-of-type(1) > p:nth-of-type(1)").text() == "서울E") {
        opp_ = $("#matchScore > div:nth-of-type(3) > p:nth-of-type(1)").text()
    } else {
        opp_ = $("#matchScore > div:nth-of-type(1) > p:nth-of-type(1)").text()
    }

    h2hList = []

    for (i = 0; i < Object.keys(data).length; i++) {
        if ((data[Object.keys(data)[i]]["home"] == opp_ || data[Object.keys(data)[i]]["away"] == opp_) && Object.keys(data)[i] < id) {
    ...
    if (!$("#recentMatch").length && !h2hList == []) {
        $("#matchH2H").append("<div id='recentMatch'></div>")
    }

    if (!$("#recentMatch > div").length) {
        if (homeImg == "seouleland_s") {
            sefc = homeImg
            opp = awayImg
        } else if (awayImg == "seouleland_s") {
            sefc = awayImg
            opp = homeImg
        }
        ...
        if (h2hList.length < 5) {
            for (i = 0; i < h2hList.length; i++) {
                ...
                if (data[h2hList[i]]["home"] == "서울E") {
                    $("#recentMatch > div:nth-of-type(" + (i + 1) + ") > div:nth-of-type(1) > div:nth-of-type(1) > img").attr("src", "./files/seouleland_s.png")
                    $("#recentMatch > div:nth-of-type(" + (i + 1) + ") > div:nth-of-type(1) > div:nth-of-type(3) > img").attr("src", "./files/" + opp + ".png")
                    ...
                    $("#recentMatch > div:nth-of-type(" + (i + 1) + ") > div:nth-of-type(1) > div:nth-of-type(1) > img").attr("src", "./files/" + opp + ".png")
                ...
                $("#recentMatch > div:nth-of-type(" + (i + 1) + ") > div:nth-of-type(1) > div:nth-of-type(2) > img").attr("src", "./files/" + data[h2hList[i]]["comp"].replace("k2", "kleague40_s").replace("fa", "facup_s").replace("kj8f", "kleague40_s").replace("kj8s", "kleague40_s").replace("kj5", "kleague40_s").replace("mcst", "mcst_s").replace("kf8", "kfa_s").replace("kyc8", "kleagueyouthchampionship_s").replace("kyc5", "kleagueyouthchampionship_s").replace("yd", "kfa_s") + ".png")
