data = {
    ...
    "gimcheonsangmu": ["002649", "c5a775", "1", "1", "5", "5", "11"],
    ...
    "seongnamfc": ["000000", "ffffff", "3", "5", "3", "13", "13"],
    ...
    "fcanyang": ["4f1b87", "cda55f", "7", "9", "18", "34", "51"],
...
if ($("#matchScore > div:nth-of-type(1)").find("img").attr("src").replace("https://sefc.info/files/", "").replace("_s.png", "") == "seouleland") {
    ...
    if ($(window).width() < 768) {
        $("#matchH2H > div:nth-of-type(2) > div:nth-of-type(1) > p:nth-of-type(1)").css({ "width": "10vw", "height": "10vw", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
        ...
        $("#matchH2H > div:nth-of-type(4) > div:nth-of-type(1) > p:nth-of-type(1)").css({ "width": "10vw", "height": "10vw", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
        ...
        $("#matchH2H > div:nth-of-type(2) > div:nth-of-type(1) > p:nth-of-type(1)").css({ "width": "40px", "height": "40px", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
        ...
        $("#matchH2H > div:nth-of-type(4) > div:nth-of-type(1) > p:nth-of-type(1)").css({ "width": "40px", "height": "40px", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
    ...
    if ($(window).width() < 768) {
        ...
        $("#matchH2H > div:nth-of-type(2) > div:nth-of-type(2) > p:nth-of-type(1)").css({ "width": "10vw", "height": "10vw", "font-size": "16px", "border-radius": "10px", "background": "#c8c8c8", "color": "#fafafa", "display": "flex", "align-items": "center", "justify-content": "center"});
        $("#matchH2H > div:nth-of-type(2) > div:nth-of-type(3) > p:nth-of-type(1)").css({ "width": "10vw", "height": "10vw", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
        ...
        $("#matchH2H > div:nth-of-type(4) > div:nth-of-type(2) > p:nth-of-type(1)").css({ "width": "10vw", "height": "10vw", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
    } else {
        ...
        $("#matchH2H > div:nth-of-type(2) > div:nth-of-type(2) > p:nth-of-type(1)").css({ "width": "40px", "height": "40px", "font-size": "16px", "border-radius": "10px", "background": "#c8c8c8", "color": "#fafafa", "display": "flex", "align-items": "center", "justify-content": "center"});
        $("#matchH2H > div:nth-of-type(2) > div:nth-of-type(3) > p:nth-of-type(1)").css({ "width": "40px", "height": "40px", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"});
        ...
        $("#matchH2H > div:nth-of-type(4) > div:nth-of-type(2) > p:nth-of-type(1)").css({ "width": "40px", "height": "40px", "font-size": "16px", "border-radius": "10px", "background": "#000831", "color": "#174fff", "display": "flex", "align-items": "center", "justify-content": "center"})
    }
};
